...
```{r}
county_locations = grep(pattern = ", \\w\\w", long_updated$area_name)

EDU01_long_updated_county = long_updated[county_locations, ]

class(EDU01_long_updated_county) <- c("County", class(EDU01_long_updated_county))

EDU01_long_updated_non_county = long_updated[-county_locations, ]
